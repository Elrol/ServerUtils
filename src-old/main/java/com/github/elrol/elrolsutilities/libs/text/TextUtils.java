...
public class TextUtils {
    ...
    public static StringTextComponent formatChat(ServerPlayerEntity player, String msg){
        ...
        if (FeatureConfig.color_chat_enable.get()) {
            if (IElrolAPI.getInstance().getPermissionHandler().hasPermission(player.createCommandSource(), FeatureConfig.color_chat_perm.get())) {
    ...
    public static void msg(ServerPlayerEntity player, TextComponent translation) {
        TextUtils.msg(player.createCommandSource(), translation);
    }
    ...
    public static void err(ServerPlayerEntity player, TextComponent translation) {
        TextUtils.err(player.createCommandSource(), translation);
    }
    ...
    public static void sendMessage(CommandSource source, ServerPlayerEntity player, String msg) {
        ...
        message += Methods.getDisplayName(player.createCommandSource());
        message += TextFormatting.DARK_GRAY + "] " + TextFormatting.GRAY;
        message = FeatureConfig.color_chat_enable.get() && IElrolAPI.getInstance().getPermissionHandler().hasPermission(player.createCommandSource(), FeatureConfig.color_chat_perm.get()) ? message + TextUtils.formatString(msg) : message + msg;
