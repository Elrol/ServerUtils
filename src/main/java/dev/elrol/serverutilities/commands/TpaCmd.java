...
extends _CmdBase {
    ...
    implements Runnable {
        ...
        @Override
        public void run() {
            Main.textUtils.msg(this.requester, Msgs.tpa_sent.get(Methods.getDisplayName(this.target)));
            Main.textUtils.msg(this.target, Msgs.tpa_received.get(Methods.getDisplayName(this.requester)));
