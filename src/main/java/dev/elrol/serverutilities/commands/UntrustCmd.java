...
extends _CmdBase {
    ...
    protected int execute(CommandContext<CommandSourceStack> c) {
        ...
        if(data.isTrusted(target.getUUID())) {
            ...
            Main.textUtils.err(player, Errs.not_trusted(tdata.getDisplayName()));
            return 0;
        }
        return 1;
    }
    ...
    private static class CommandRunnable
        ...
        public CommandRunnable(ServerPlayer player, ServerPlayer target) {
            this.player = player;
            this.target = target;
        }
        ...
        public void run() {
            ...
            Main.textUtils.msg(player, Msgs.untrusted_player.get(targetData.getDisplayName()));
            Main.textUtils.err(target, Errs.untrusted_by_player(playerData.getDisplayName()));
        }
    }
