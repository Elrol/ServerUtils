...
extends _CmdBase {
    ...
    protected int execute(CommandContext<CommandSourceStack> c) {
        ...
        if(data.isTrusted(target.getUUID())) {
            Main.textUtils.err(player, Errs.is_trusted(tdata.getDisplayName()));
            return 0;
        } else {
    ...
    private static class CommandRunnable
        ...
        public void run() {
            ...
            Main.textUtils.msg(player, Msgs.trusted_player.get(targetData.getDisplayName()));
            Main.textUtils.msg(target, Msgs.trusted_by_player.get(playerData.getDisplayName()));
        }
    }
