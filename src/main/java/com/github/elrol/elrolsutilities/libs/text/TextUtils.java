...
public class TextUtils {
    ...
    public static Component commandHelp(String[] content) {
    ...
    public static Component formatChat(UUID uuid, Component msg) {
        return formatChat(uuid, msg.getString());
    }

    public static Component formatChat(UUID uuid, String msg){
        IPlayerData data = Main.database.get(uuid);
    ...
    public static void msgNoTag(ServerPlayer player, Component message) {
    ...
    public static void msg(CommandContext<CommandSourceStack> context, Component translation) {
        TextUtils.msg(context.getSource(), translation);
    }

    public static void msg(ServerPlayer player, Component translation) {
    ...
    public static void msgNoTag(CommandSourceStack source, Component text){
        source.sendSuccess(text, false);
    }

    public static void msg(CommandSourceStack source, Component translation) {
        source.sendSuccess(Component.literal(ModInfo.getTag()).append(translation), false);
    }

    public static void err(CommandContext<CommandSourceStack> context, Component translation) {
        TextUtils.err(context.getSource(), translation);
    }

    public static void err(ServerPlayer player, Component translation) {
    ...
    public static void err(CommandSourceStack source, Component translation) {
