...
public class RtpCmd
extends _CmdBase {
    public RtpCmd(ForgeConfigSpec.IntValue delay, ForgeConfigSpec.IntValue cooldown, ForgeConfigSpec.ConfigValue<List<? extends String>> aliases, ForgeConfigSpec.IntValue cost) {
    ...
    implements Runnable {
        ...
        @Override
        public void run() {
            Methods.randomTeleport(this.player, CommandConfig.rtpnear_max.get(), CommandConfig.rtp_max.get());
        }
    }
