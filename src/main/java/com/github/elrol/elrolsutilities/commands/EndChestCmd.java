...
extends _CmdBase {
    ...
    implements Runnable {
        ...
        @Override
        public void run() {
            this.player.openMenu(new SimpleMenuProvider((id, inv, player) -> ChestMenu.threeRows(id, inv, player.getEnderChestInventory()), new TranslatableComponent("container.enderchest")));
        }
    }
